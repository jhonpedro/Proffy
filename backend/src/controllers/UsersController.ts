...
import { createForgotPassword_tokenRepository, removeForgotPassword_tokenRepository, searchForgotPassword_tokenRepository } from '../repositories/forgotPassword_token'
...
export default {
  ...
  async forgotPasswordChange(req: Request, res: Response) {
    ...
    try {
      ...
      const tokenInDatabase = await searchForgotPassword_tokenRepository({ user_id: tokenPayload.id })
